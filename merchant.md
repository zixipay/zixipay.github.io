...
If the IPN Callback URL is set in the Merchant settings, upon receiving funds in any of the wallet addresses generated by  ```getpaymentwallet``` endpoint, an HTTPS POST will be made to the Callback URL with the following parameteres:
