...
* All the merchant API endpoints are accessible only if your [ZixiPay](https://zixipay.com){:target="_blank"} wallet is verified and the [Merchant Setting](#merchant-settings) are set and active.
